...
term：不分割词，直接匹配倒排索引。 传入的文本原封不动地（不分词）拿去查询。你输入的是湖北省， 如果结果中湖北省武汉市 是查不出来的

match_phrase： 将词分割开来，匹配倒排索引，查找这个短语。 比如湖北省武汉市， 结果中有 湖北省武汉市洪山区， 湖北省武汉市东湖隧道， 这些都能查出来，因为 结果中包含了 湖北省武汉市 整个短语
